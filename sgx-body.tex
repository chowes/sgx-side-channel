...
% talk about processor reserved memory / software attestation
% more detail about SGX specific details (e.g. asynch enclave exit, etc.)
% more detail about how memory is handled by the OS
